// Wraps fetch() with automatic retry-with-backoff on 429 rate-limit
// responses. Named for its original use with OpenAI's image API, but
// genuinely provider-agnostic — nothing in here is OpenAI-specific,
// which is exactly why ElevenLabs' TTS calls reuse it too rather than
// duplicating the same retry logic under a second filename. This is a
// real, observed failure mode, not a theoretical one: gpt-image-1.5 has a low default rate limit on new/
