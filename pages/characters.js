      ...
      <main className="min-h-screen bg-ivory_cloth text-charcoal">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-2 gap-4 px-6 pb-20 sm:grid-cols-3 md:grid-cols-4">
          {filtered.map((c) => (
            ...
            >
              <div className="mb-3 flex aspect-square items-center justify-center overflow-hidden rounded-cloth bg-indigo_night/10 p-7 font-display text-3xl text-indigo_night/40">
                {libraryImages[c.id] ? (
        ...
        {selected && (
          ...
          >
            ...
            >
              <div className="mx-auto mb-4 flex h-32 w-32 items-center justify-center overflow-hidden rounded-cloth bg-indigo_night/10 p-5 font-display text-4xl text-indigo_night/40">
